...
class StorageTests: BaseTestContext {
    ...
    func testUploadFile() throws {
        ...
        let request = UploadFileRequest(file: InputStream(url: localPath)!, path: remotePath);
    ...
    func testCopyFile() throws {
        ...
        try super.uploadFile(file: self.getLocalTestDataFolder().appendingPathComponent(localName, isDirectory: false), path: remoteBasePathSrc);
